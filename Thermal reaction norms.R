...
# Plot
param <- trop[1,]
plot(seq(Tmin,Tmax,1), m(seq(Tmin,Tmax,1)), type="l", lwd=1, col="red", xlim=c(Tmin,Tmax), ylim=c(ymin,ymax), xlab="T", ylab="m(T)")
for(i in 2:nrow(trop)) {
  param <- trop[i,]
  points(seq(Tmin,Tmax,1), m(seq(Tmin,Tmax,1)), type="l", lwd=1, col="red", xlim=c(Tmin,Tmax), ylim=c(ymin,ymax), xlab="T", ylab="m(T)")
}
for(i in 1:nrow(subtrop)) {
  param <- subtrop[i,]
  points(seq(Tmin,Tmax,1), m(seq(Tmin,Tmax,1)), type="l", lwd=1, col="orange", xlim=c(Tmin,Tmax), ylim=c(ymin,ymax), xlab="T", ylab="m(T)")
}
for(i in 1:nrow(temp)) {
  param <- temp[i,]
  points(seq(Tmin,Tmax,1), m(seq(Tmin,Tmax,1)), type="l", lwd=1, col="blue", xlim=c(Tmin,Tmax), ylim=c(ymin,ymax), xlab="T", ylab="m(T)")
}
